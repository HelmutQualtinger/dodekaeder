...
| `nudeldrucker.html` | **Austrian public-figures edition.** Richard Lugner, DJ Ötzi, Heinz Fischer, Leonore Gewessler, Andreas Babler, Armin Wolf, Conchita Wurst, Alexander Van der Bellen, Hermes Phettberg, Thomas Bernhard, Erika Pluhar, Elfriede Jelinek. Same engine/UX as `gemini.html` (embedded base64 portraits, German UI, names hidden until click, installable PWA via `manifest-nudeldrucker.json`). |
